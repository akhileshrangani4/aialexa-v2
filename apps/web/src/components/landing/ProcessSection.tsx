...
export default function ProcessSection() {
  const steps = [
    { number: "01", title: "Create", description: "Sign up and create your first chatbot in minutes. No technical skills needed." },
    { number: "02", title: "Upload", description: "Add your course materials. Our AI processes and indexes everything automatically." },
    { number: "03", title: "Share", description: "Share the link with your students and watch engagement soar." }
  ];
