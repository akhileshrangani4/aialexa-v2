        ...
        <div className="grid md:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg mb-8 leading-relaxed">
              Powered by cutting-edge open-source AI models and retrieval-augmented generation. 
              Your chatbots understand context and provide accurate, source-based answers.
            </p>
